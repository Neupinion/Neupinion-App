  ...
  return (
    <View style={styles.container}>
      <View style={styles.chartContainer}>
        <ReportBubbleChart height={320} width={WINDOW_WIDTH - 68} data={keyword} />
      </View>
      <View style={styles.textContainer}>
        <Text style={styles.titleText}>{position} 입장 유의키워드</Text>
        <Text style={styles.contentText}>
          뉴피니언의 컨텐츠는, 특정 입장에 유리하게 작성된 컨텐츠들을 모아 에디터가 각각 쉽고
          친근하게 작성해주고 있어요.
        </Text>
        <Text style={styles.contentText}>
          {position}의 입장에서 작성된 글을 읽을 때에는, 다음과 같은 키워드를 유심히 생각하면서
          읽으시는걸 추천드려요.
        </Text>
      </View>
    </View>
